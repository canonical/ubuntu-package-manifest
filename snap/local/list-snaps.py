    ...
    with open(snap_state_file_path, "r") as snap_state_file:
        ...
        for snap_name in snap_names:
            ...
            installed_snap_details.append(
                (snap_name, snap_tracking_channel, snap_current_revision)
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Root directory to search for installed snaps (Default is {})"
             .format(DEFAULT_ROOT_DIR),
    )
    ...
    for installed_snap_detail in installed_snap_details:
        print(
            "snap:{}\t{}\t{}".format(
                installed_snap_detail[0],
                installed_snap_detail[1],
                installed_snap_detail[2],
            )
        )
